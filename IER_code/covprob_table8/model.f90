...
signout = 0
ALFA_R   = 0.7D+0!Thetta(1)!0.0D+0!Thetta(1)
ALFA_PAI = 0.5D+0!Thetta(2)!1.5D+0!Thetta(2)!1.1D+0!
ALFA_Y   = 0.15D+0!Thetta(3)!0.0D+0!Thetta(3)
BETTA    = 0.99D+0!Thetta(2)
KAPA     = Thetta(1)!(1.0D+0-ALFA)*(1.0D+0-ALFA*BETTA)/ALFA
RHO_th   = Thetta(2)
RHO_eps  = Thetta(3)
RHO_gam  = Thetta(4)
Y        = 1.0D+0
