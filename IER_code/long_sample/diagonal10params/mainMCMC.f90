...
INTEGER, PARAMETER :: Ndraws = 1000000, Whentosave = Ndraws, SaveEach = 100
REAL(8) ::  sig_xi 
...
IF ( 1 == 2) THEN
    ...
    CALL RANDOM_SEED()
     ...
     shock_place(sth)  = (x(1,8))*0.01D+0
     shock_place(seps) = (x(1,9))*0.01D+0
     shock_place(sgam) = (x(1,10))*0.01D+0
