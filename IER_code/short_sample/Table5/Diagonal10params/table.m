...
for i = 1:num_theta 
    ...
    table_vtheta = [table_vtheta a num2str(vtheta(:,i),'% 10.4g') ];% a num2str(vtheta(:,2),'% 10.2g') a num2str(vtheta(:,3),'% 10.2g') a num2str(vtheta(:,4),'% 10.2g') a num2str(0.0001*vtheta(:,5),'% 10.2g') a num2str(0.0001*vtheta(:,6),'% 10.2g')  b ]
end
disp('v lte')
table_vg = [table_vg b]
disp('vtheta')
