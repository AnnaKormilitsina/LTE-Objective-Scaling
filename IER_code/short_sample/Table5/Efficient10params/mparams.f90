...
INTEGER, PUBLIC, PARAMETER :: num_thetta = 10, num_MOM = 3,   num_shocks = 3, nlags = 4, size_data = 200! 5000! 200!225 
!INTEGER, PUBLIC, PARAMETER ::  num_thetta = 7,  num_MOM = 3,   num_shocks = 3, nlags = 4, size_data =  200
